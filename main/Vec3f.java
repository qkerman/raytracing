...
class Vec3f {
	 ...
	 * @return current vector
	 */
	public Vec3f thisAdd(final Vec3f that)
	{
		this.x+=that.x;
		this.y+=that.y;
		this.z+=that.z;
	 ...
	 * @return current vector
	 */
	public Vec3f thisSub(final Vec3f that)
	{
		this.x-=that.x;
		this.y-=that.y;
		this.z-=that.z;
	 ...
	 * @return current vector
	 */
	public Vec3f thisScale(final float scale)
	{
		this.x*=scale;
		this.y*=scale;
		this.z*=scale;
	 ...
	 * @return current vector
	 */
	public Vec3f thisScale(final float scalex,final float scaley,final float scalez)
	{
		this.x*=scalex;
		this.y*=scaley;
		this.z*=scalez;
